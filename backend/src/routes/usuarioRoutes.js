...
router.put("/:id", UsuarioController.isAdmin, UsuarioController.atualizar);    // Atualizar usuário
router.delete("/:id", UsuarioController.isAdmin, UsuarioController.deletar);   // Deletar usuário
